...
class PlaybackStartEventGenerator(BaseEventGenerator):
    """Generate playback_start streaming events."""
    ...
    def generate_event(self, user_ctx: Dict[str, Any], ts: datetime) -> Dict[str, Any]:
        ...
        event["playback_position_seconds"] = 0
        return event
